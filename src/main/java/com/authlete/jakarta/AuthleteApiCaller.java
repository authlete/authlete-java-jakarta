...
class AuthleteApiCaller
{
            ...
            Options options)
    {
        return authorizationIssue(
                ticket, subject, authTime, acr, claims, properties, scopes, null, options);
    }
    ...
    public Response authorizationIssue(
            String ticket, String subject, long authTime, String acr,
            Map<String, Object> claims, Property[] properties, String[] scopes, String sub, Options options)
    {
        return authorizationIssue(
            ...
            MultivaluedMap<String, String> parameters, String clientId, String clientSecret, Options options)
    {
        ...
        return callRevocation(params, clientId, clientSecret, options);
    }
    ...
    private RevocationResponse callRevocation(
            String parameters, String clientId, String clientSecret, Options options)
    {
        if (parameters == null)
        {
            // Authlete returns different error codes for null and an empty string.
    ...
    public UserInfoResponse callUserInfo(
            String accessToken, String clientCertificate, String dpop, String htm, String htu, Options options)
    {
    ...
    public BackchannelAuthenticationResponse callBackchannelAuthentication(
            MultivaluedMap<String, String> parameters, String clientId, String clientSecret,
            String clientCertificate, String[] clientCertificatePath, Options options)
    {
        String params = URLCoder.formUrlEncode(parameters);

        return callBackchannelAuthentication(
                params, clientId, clientSecret, clientCertificate, clientCertificatePath, options);
    }
     ...
     */
    public BackchannelAuthenticationIssueResponse callBackchannelAuthenticationIssue(
            String ticket, Options options)
    {
            ...
            String clientCertificate, String[] clientCertificatePath, Options options)
    {
        ...
        return callDeviceAuthorization(
                ...
                clientCertificate, clientCertificatePath, options);
    }
    ...
    callCredentialJwtIssuerMetadata(CredentialJwtIssuerMetadataRequest request, Options options)
    {
        try
        {
