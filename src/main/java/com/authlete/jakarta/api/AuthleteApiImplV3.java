...
public class AuthleteApiImplV3 extends AuthleteApiJaxrsImpl
{
    ...
    private TokenListResponse getTokenList(
            ...
            final int start, final int end, final boolean rangeGiven, TokenStatus tokenStatus,
    ...
    private TokenListResponse callGetTokenList(
            ...
            TokenStatus tokenStatus, Options options)
    {
    ...
    {
        executeApiCall(
                new DeleteApiCaller(SERVICE_DELETE_API_PATH, apiKey)
                .setOptions(options));
    }
